...
3. **driver**: To connect to MySQL, keep the value of *'com.mysql.jdbc.Driver'*. If you want to use a different database, please consult [here](https://www.mathworks.com/help/database/ug/database.html?requestedDomain=www.mathworks.com).
